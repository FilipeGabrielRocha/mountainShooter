...
import pygame
from pygame.constants import KEYDOWN, K_RETURN, K_BACKSPACE, K_DOWN, K_ESCAPE
...
class Score:
    def __init__(self, window: Surface):
        self.window = window
        # 1- carrego a imagem
        self.surf = pygame.image.load('./asset/images/ScoreBg.png').convert_alpha()
        # 2- posiciono a imagem
        self.rect = self.surf.get_rect(left=0, top=0)

    def save(self, game_mode: str, player_score: list[int]):
        # Adicionando a música
        pygame.mixer_music.load('./asset/music/Score.mp3')
